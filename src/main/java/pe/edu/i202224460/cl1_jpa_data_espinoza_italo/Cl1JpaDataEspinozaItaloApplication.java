...
import pe.edu.i202224460.cl1_jpa_data_espinoza_italo.repository.CountryLanguageRepository;
...
//						.forEach(language -> System.out.println("MESSI XD -> "+language.getId().getLanguage())),
//				() -> {
//					Optional<Country> countryPeru = countryRepository.findById("PER");
//					countryPeru.ifPresent(peru -> peru.getCountryLanguages()
//							.forEach(language -> System.out.println("PAOLO XD -> "+language.getId().getLanguage())));
//				}
//		);
